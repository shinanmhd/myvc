                    ...
                    calendar.createEvents([
                        {
                            ...
                            subtitle: 'this',
                            start: '{{ \Carbon\Carbon::parse(today())->setTIme(05, 0, 0)->toIso8601String() }}',
                            end: '{{ \Carbon\Carbon::parse(today())->setTIme(05, 0, 0)->addHours(2)->toIso8601String() }}',
                        },
                        {
                            id: 'event2',
                            calendarId: 'cal1',
                            title: 'Information Security',
                            start: '{{ \Carbon\Carbon::parse(today())->setTIme(8, 0, 0)->toIso8601String() }}',
                            end: '{{ \Carbon\Carbon::parse(today())->setTIme(8, 0, 0)->addHours(2)->toIso8601String() }}',
                        },
                        {
                            id: 'event3',
                            calendarId: 'cal1',
                            title: 'Project Management',
                            start: '{{ \Carbon\Carbon::parse(today())->setTIme(11, 0, 0)->toIso8601String() }}',
                            end: '{{ \Carbon\Carbon::parse(today())->setTIme(11, 0, 0)->addHours(2)->toIso8601String() }}',
                        },
                        {
                            id: 'event4',
                            calendarId: 'cal1',
                            title: 'Digital Design and Development',
                            start: '{{ \Carbon\Carbon::parse(today())->setTIme(14, 0, 0)->toIso8601String() }}',
                            end: '{{ \Carbon\Carbon::parse(today())->setTIme(14, 0, 0)->addHours(2)->toIso8601String() }}',
                        },
                    ]);
